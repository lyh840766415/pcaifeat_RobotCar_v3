...
IMG_MODEL_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3/log/train_save_v3_resnet/img_model_00156052.ckpt"
# log path
LOG_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3/log/train_save_v3_resnet/"
...
def model_save(sess,step,train_saver):
	...
	print("resnet Model saved in file: %s" % save_path)
	return
