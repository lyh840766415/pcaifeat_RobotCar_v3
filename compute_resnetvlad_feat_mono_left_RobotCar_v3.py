...
def save_feat_to_file(database_feat,query_feat):
	output_to_file(database_feat["img_feat"],"database_img_feat_resnetvlad_"+IMG_MODEL_PATH[-13:-5]+".pickle")
	output_to_file(query_feat["img_feat"],"query_img_feat_resnetvlad_"+IMG_MODEL_PATH[-13:-5]+".pickle")
