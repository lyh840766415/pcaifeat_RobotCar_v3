...
# log path
LOG_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3/log/train_save_v3_resnet_stereo_centre/"
...
PC_IMG_MATCH_FILE = 'generate_queries_v3/stereo_centre_pointcloud_image_match.pickle'
