...
IMG_MODEL_PATH = "/data/lyh/lab/pcaifeat_RobotCar_v3/log/train_save_v3_resnetvlad_no_norm/img_model_00240080.ckpt"
...
def save_feat_to_file(database_feat,query_feat):
	output_to_file(database_feat["img_feat"],"database_img_feat_resnetvlad_no_norm_"+IMG_MODEL_PATH[-13:-5]+".pickle")
	output_to_file(query_feat["img_feat"],"query_img_feat_resnetvlad_no_norm_"+IMG_MODEL_PATH[-13:-5]+".pickle")
